...
public class T1_isDisplayedFalse {
    public static void main(String[] args) {
        ...
        WebElement solarPanelHeader = driver.findElement(By.xpath("//h1[contains(text(),'Solar Panel')][1]"));

        //4- Verify if it is dispayed on the page
        System.out.println("Solar Panel Header is displayed? " + solarPanelHeader.isDisplayed());
